...
export interface AccountDto {
  ...
  currentBalanceMinor: number; // Derived balance
  institution?: string;
  last4?: string;
  notes?: string;
  isArchived: boolean;
...
export class AccountService {
  constructor(private accountRepo: AccountRepository = accountRepository) {}

  private mapToDto(account: IAccount): AccountDto {
    return {
      ...
      currentBalanceMinor: account.openingBalanceMinor, // In Phase 4, will aggregate ledger
